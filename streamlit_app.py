...
occupation = st.selectbox("Occupation", ["Employed", "Self-employed", "Student", "Retired", "Unemployed"], index=3)
...
if st.button("Submit"):
    ...
    try:
        ...
        response = requests.post(f"{FASTAPI_URL}/profile/", json=profile_data)
